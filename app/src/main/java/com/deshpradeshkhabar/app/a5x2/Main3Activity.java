package com.deshpradeshkhabar.app.a5x2;
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if(url.startsWith("https://www.facebook.com") || url.startsWith("https://m.facebook.com")){
                    ...
                    if(url.startsWith("https://telegram")){
                ...
                if (url != null && (url.startsWith("https://vk.com") || url.startsWith("https://m.vk.com"))) {
                    view.stopLoading();
                ...
                if (url != null && (url.startsWith("https://telegram") || url.startsWith("https://www.telegram") || url.startsWith("https://m.twitter.com/"))) {
                    view.stopLoading();
                ...
                if (url != null && (url.startsWith("https://www.linkedin.com") || url.startsWith("https://linkedin.com"))) {
                    view.stopLoading();
                ...
                if (url != null && (url.startsWith("https://access.line"))) {
                    view.stopLoading();
...
//            pd.show();
        ...
        mWebView.loadUrl("https://deshpradeshkhabar.com/");
